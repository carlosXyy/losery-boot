...
module.exports = {
    criacaoEnv: async ()=>{
        ...
        let schema = {
         ...
         "NOME_ADMINISTRADOR=carlosX\n"+
         "NOME_BOT=LOSERBOT\n"+
         "NOME_AUTOR_FIGURINHAS = LOSERBOT\n\n"+
         "############ CONFIGURAÇÕES DO BOT #############\n\n"+
         "# LEMBRE-SE SEU NÚMERO DE WHATSAPP E NÃO O DO BOT. (COM CÓDIGO DO PAÍS INCLUÍDO)\n"+
         "NUMERO_DONO=+558499034946\n"+
    ...
    verificarEnv:()=>{
        ...
        let resposta = {
            numero_dono : {
               resposta: (process.env.NUMERO_DONO.trim() == "558499034946") ? "O número do DONO ainda não foi configurado" : "✓ Número do DONO configurado.",
               cor_resposta: (process.env.NUMERO_DONO.trim() == "558499034946") ? "#d63e3e" : false
            },
            newsapi : {
